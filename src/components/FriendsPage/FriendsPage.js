    ...
    render() {
        ...
        <div id="friendsPage" className="friendsPage">
            ...
            <div className='invitesInfo'>
                <img width="50px" height="50px" src='https://citovichartem.github.io/build/img/белподарок.png'/>
            ...
            <div className='invitesInfo secondInvitesInfo'>
                <img width="50px" height="50px" src='https://citovichartem.github.io/build/img/чернподарок.png'/>
                <div className='invitesText'>
